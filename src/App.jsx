      ...
      <div style={{ background: "#0A5C36", color: "#fff", padding: "12px 24px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            }}><Lock size={15} /> Dashboard admin</button>
          </div>
        </div>
      </div>
          ...
          isAdminUnlocked ? (
            <div>
              <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 12 }}>
                <button
                  onClick={() => { setIsAdminUnlocked(false); setView("input"); }}
                  style={{
                    display: "flex", alignItems: "center", gap: 6, padding: "7px 12px",
                    borderRadius: 8, border: "1px solid #DDD", background: "#fff",
                    color: "#5F5E5A", cursor: "pointer", fontSize: 12.5, fontWeight: 500
                  }}
                >
                  <Lock size={14} /> Kunci dashboard
                </button>
              </div>
              <AdminDashboard leads={leads} onUpdate={updateLead} />
            </div>
          ) : (
            <AdminGate onUnlock={() => setIsAdminUnlocked(true)} />
          )
        )}
      </div>
    </div>
