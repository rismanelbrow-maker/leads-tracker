...
const MOBILE_CSS = `
  * { box-sizing: border-box; }
  ...
  .mobile-bottom-nav button { -webkit-tap-highlight-color: transparent; }
  @media (max-width: 768px) {
    .mobile-header { padding: 12px 14px 14px !important; }
    .mobile-header-logos img { max-width: 44%; height: auto !important; max-height: 34px; }
    .mobile-header-title { font-size: 15px; line-height: 1.25; }
    .mobile-header-subtitle { font-size: 11px; margin-top: 3px; }
    .desktop-main-nav { display: none !important; }
    .mobile-content { width: 100%; padding: 16px 12px 92px; }
    .portal-tabs { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 16px; }
    .portal-tabs button { min-height: 44px !important; padding: 8px 10px !important; font-size: 12px !important; }
    .mobile-app input, .mobile-app select, .mobile-app textarea {
      font-size: 16px !important;
      min-height: 44px;
    }
    .mobile-app textarea { min-height: 90px; }
    .mobile-app button { min-height: 42px; }
    .simulator-header { flex-direction: column; gap: 10px; }
    .simulator-header > div:last-child { width: 100%; }
    .simulator-header > div:last-child button { width: 100%; }
    .simulator-data-card, .simulator-result-card { padding: 14px !important; border-radius: 12px !important; }
    .simulator-metrics { grid-template-columns: repeat(2, 1fr); gap: 8px; }
    .simulator-metrics > div { padding: 12px !important; min-width: 0; }
    .simulator-metrics > div > div:last-child { font-size: 14px !important; word-break: break-word; }
    .simulator-table-wrap { margin: 0 -2px; }
    .mobile-app table { font-size: 12px !important; }
    .simulator-table-wrap table { min-width: 640px; }
    .admin-table-wrap { margin: 0 -4px; }
    .mobile-bottom-nav {
      position: fixed; z-index: 1000; left: 0; right: 0; bottom: 0;
      display: grid; grid-template-columns: repeat(3, 1fr);
      background: rgba(255,255,255,.98); border-top: 1px solid #DCD4C0;
      box-shadow: 0 -4px 18px rgba(0,0,0,.08); padding: 6px 8px calc(6px + env(safe-area-inset-bottom));
    }
    .mobile-bottom-nav button {
      border: 0; background: transparent; color: #6B6B65; border-radius: 10px;
      padding: 7px 4px; display: flex; flex-direction: column; align-items: center;
      justify-content: center; gap: 3px; font-size: 10px; font-weight: 600; cursor: pointer;
    }
    .mobile-bottom-nav button.active { background: #EAF3DE; color: #0A5C36; }
    .mobile-bottom-nav button.locked { color: #6B6B65; }
    .mobile-bottom-nav svg { width: 19px; height: 19px; }
  }
  @media (max-width: 390px) {
    .mobile-content { padding-left: 10px; padding-right: 10px; }
    .simulator-metrics { grid-template-columns: 1fr; }
