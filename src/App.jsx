...
function AdminDashboard({ leads, onUpdate, onLock }) {
        ...
        {onLock && (
          <button
            ...
            style={{
              ...
              borderRadius: 8, border: "1px dashed #D3D1C7", cursor: "pointer", fontSize: 13.5, fontWeight: 500,
              marginTop: 12, background: "transparent", color: "#A32D2D",
            }}
          >
            <Lock size={16} />
            {sidebarOpen && "Kunci Dashboard"}
          </button>
        )}
      </div>
...
<body>
  ...
  return (
    <div style={{ fontFamily: "Georgia, 'Iowan Old Style', serif", color: "#16302C" }}>
      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 16, borderBottom: "2px solid #123530", paddingBottom: 14, marginBottom: 22, flexWrap: "wrap" }}>
        <div>
      ...
      <div style={{ background: "#fff", border: "1px solid #DCD4C0", borderRadius: 10, padding: 22, marginBottom: 20 }}>
      ...
      <div style={{ background: "#fff", border: "1px solid #DCD4C0", borderRadius: 10, padding: 22 }}>
    ...
    <div style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", background: "#F8F9FA", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "28px 24px 60px" }}>
        {view === "input" ? (
          ...
          <AdminDashboard leads={leads} onUpdate={updateLead} onLock={() => setAdminUnlocked(false)} />
        )}
      </div>
    </div>
  );
